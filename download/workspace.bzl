...
def tf_repositories(path_prefix = "", tf_repo_name = ""):
    ...
    tf_http_archive(
        ...
        urls = [
	    "http://deal-ii.com/download/49177915a14a.tar.gz",
    ...
    tf_http_archive(
        ...
        urls = [
	    "http://deal-ii.com/download/six-1.10.0.tar.gz",
    ...
    tf_http_archive(
        ...
        urls = [
	"http://deal-ii.com/download/astor-0.7.1.tar.gz",
    ...
    tf_http_archive(
        ...
        urls = [
	    "http://deal-ii.com/download/pypi-v0.7.1.tar.gz",
    ...
    PROTOBUF_URLS = [
       "http://deal-ii.com/download/310ba5ee72661c081129eb878c1bbcec936b20f0.tar.gz",
    ...
    tf_http_archive(
        ...
        urls = [
	"http://deal-ii.com/download/7a7e03f906aada0cf4b749b51213fe5784eeff84.tar.gz",
    ...
    tf_http_archive(
        name = "pybind11",
        urls = [
            "http://deal-ii.com/download/v2.3.0.tar.gz",
